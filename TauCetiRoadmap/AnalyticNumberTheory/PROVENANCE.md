...
- **Source proposal(s):** [roed-math PR #8](https://github.com/roed-math/TauCetiRoadmap/pull/8).
- **Mathematical reorganization:** This extracts the reusable density, Euler-product, Abel-summation, and Wiener–Ikehara material from roed-math PR #8 and the withdrawn Tau Ceti Chebotarev draft (PR #181).
