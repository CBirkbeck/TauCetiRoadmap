...
- **Source proposal(s):** [roed-math PR #6](https://github.com/roed-math/TauCetiRoadmap/pull/6).
- **Mathematical reorganization:** This extracts the arithmetic carriers from roed-math PR #6 and the order-theoretic carriers needed by PR #7 and PR #8.
