...
- **Source proposal(s):** [roed-math PR #9](https://github.com/roed-math/TauCetiRoadmap/pull/9).
- **Mathematical reorganization:** This is a revised form of roed-math PR #9.  It must extend, rather than duplicate, the Frobenius API already present in Tau Ceti.
